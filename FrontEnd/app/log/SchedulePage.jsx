...
const SchedulePage = () => {
	...
	const submitWork = (start, end, name,dates) => {
		...
		axios.put('https://eb98-188-2-139-122.ngrok-free.app/addWork', {
		  data,
		  id: user._id,
		  clicked,
		  dayIndices,
    ...
    const deleteFunc = () => {
        axios.put('https://eb98-188-2-139-122.ngrok-free.app/deleteWork', {
            id: user._id,
            index,
            clicked,
        }).then(res => {
    ...
    const editFunc = (start, end, name) => {
        ...
        axios.put('https://eb98-188-2-139-122.ngrok-free.app/editWork', {
            data,
            id: user._id,
            index,
            clicked,
