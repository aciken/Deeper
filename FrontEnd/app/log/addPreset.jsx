...
const saveEdit = () => {
	...
	axios.put('https://eb98-188-2-139-122.ngrok-free.app/editPreset', {
...
const addToSchedule = () => {
	...
	axios.put('https://eb98-188-2-139-122.ngrok-free.app/addToSchedule', {	
		preset: editedPreset.sessions.length > 0 ? editedPreset : newPreset,
		id: user._id,
...
const deletePreset = () => {
	...
	axios.put('https://eb98-188-2-139-122.ngrok-free.app/deletePreset', {
		id: user._id,
		presetIndex,
	})
	.then(res => {
...
const restorePreset = () => {
	const presetIndex = user.preset.findIndex(pre=> pre.name == newPreset.name)
	axios.put('https://eb98-188-2-139-122.ngrok-free.app/restorePreset', {
		id: user._id,
		presetIndex,
	})
	.then(res => {
